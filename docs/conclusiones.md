...
La utilización de una Plataforma Web Progresiva (PWA) también permitió incorporar funcionalidades para escenarios con conectividad limitada, facilitando el acceso a la herramienta en zonas rurales.
